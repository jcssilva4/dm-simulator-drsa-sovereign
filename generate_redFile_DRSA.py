...
#red1
'''
criteriaSet = ["Exports of goods and services (% of GDP)", "Foreign direct investment, net inflows (BoP, current US$)",
"Real interest rate (%)", "GNI per capita, Atlas method (current US$)","Total reserves (includes gold, current US$)"] 
'''
#red2
'''
criteriaSet = ["Exports of goods and services (% of GDP)", "Foreign direct investment, net inflows (BoP, current US$)",
"Real interest rate (%)", "Total reserves (includes gold, current US$)", "GDP per capita (current US$)"] 
'''
#red3
'''
criteriaSet = ["Exports of goods and services (% of GDP)", "Foreign direct investment, net inflows (BoP, current US$)",
"Real interest rate (%)","GNI per capita, Atlas method (current US$)","GDP (current US$)"] 
'''
#red4

criteriaSet = ["Exports of goods and services (% of GDP)", "Foreign direct investment, net inflows (BoP, current US$)",
"Real interest rate (%)","GDP per capita (current US$)","GDP (current US$)"] 
