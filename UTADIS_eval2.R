...
names(alternativesAssignments) <- c("Malaysia", "Japan", "Botswana", "Chile", "Oman", "China", "Israel", "Canada", "Czech Republic", "United States", "Kwait",
                                    "Macao SAR, China","Malta", "Aruba","Azerbaijan", "India", "Brazil", "Mauritius", "Romania", "Peru", "South Africa", "Thailand",
